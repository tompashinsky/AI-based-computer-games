...
def get_nn_action(model, player, ball, opponent):
    state = np.array([
        ...
        # --- Opponent position ---
        opponent.rect.centerx / WIDTH,
        opponent.rect.centery / HEIGHT,  # added vertical position

        # --- Ball relative to AI ---
        (ball.rect.centerx - player.rect.centerx) / WIDTH,  # ahead/behind
        abs(player.rect.centerx - ball.rect.centerx) / WIDTH,  # horizontal distance
        abs(player.rect.centery - ball.rect.centery) / HEIGHT,  # vertical distance
        abs(ball.rect.centerx - WIDTH) / WIDTH,  # distance to AI's goal
        ...
        (opponent.rect.centerx - player.rect.centerx) / WIDTH,  # horizontal distance to opponent
